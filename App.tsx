...
type USBModule = {listPorts: () => Promise<string[]>; connect: (port: string) => Promise<boolean>; disconnect: () => void; send: (command: string) => Promise<boolean>; addListener: (eventName: string) => void; removeListeners: (count: number) => void};
